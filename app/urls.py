...
urlpatterns = [
    ...
    path('admin/gebruikers/<int:user_id>/status/', views.toggle_user_active, name='toggle_user_active'),
    ...
    path(
        "beschikbaarheid/<int:beschikbaarheid_id>/verwijderen/",
        views.beschikbaarheid_verwijderen,
        name="beschikbaarheid_verwijderen",
    ),
